...
write.table(allSummary,file='wss.short.glm_summary_coli',row.names=FALSE)
write.csv(allSummary,'wss.short.glm_summary.csv_coli',row.names=F)
```
...
write.table(allSummary,file='ess.short.glm_summary_coli.RData',row.names=FALSE)
write.csv(allSummary,'ess.short.glm_summary_coli.csv',row.names=F)
...
write.table(allSummary,file='ess.long.glm_summary.RData',row.names=FALSE)
...
write.table(allSummary,file='wss.long.glm_summary_coli.RData',row.names=FALSE)
write.csv(allSummary,'wss.long.glm_summary_coli.csv',row.names=F)
