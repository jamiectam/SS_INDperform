...
#derivatives
wss.short.calc<-calc_deriv(init_tbl=wss.short.data_init, mod_tbl=wss.short.m_gam)

#pressure indicators

wss.short.it<-select_interaction(mod_tbl=wss.short.calc)

wss.short.m_all<-test_interaction(init_tbl=wss.short.data_init, mod_tbl=wss.short.calc, interactions=wss.short.it)
```
...
wss.long.calc<-calc_deriv(init_tbl=wss.long.data_init, mod_tbl=wss.long.m_gam)
...
ess.short.calc<-calc_deriv(init_tbl=ess.short.data_init, mod_tbl=ess.short.m_gam)
