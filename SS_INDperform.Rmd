...
ess.short.nl_fits<-ess.short.gam_glm %>%
                  ...
                  dplyr::filter(r_sq>0.19)#%>% select(combo)
...
colnames(SS.usefull.inds)<-SS.names
...
SS.thresh<-cbind.fill(ess.short.thresh, ess.long.thresh, wss.short.thresh, wss.long.thresh)
...
ess.common.nl_fits<-intersect(SS.nl_fits$ess.short, SS.nl_fits$ess.long) #no answers because ess.long had no l_fits
